...
$params=array(
    "type"=>5,
    "mid"=>88888894,
    "fvmids"=>'22-88888894,19-88888894,25-88888894'
);
...
$url = "http://127.0.0.1:6010/x/internal/v3/fav/folder/multi";
// $url = "http://api.bilibili.co/x/internal/v3/fav/folder/multi";
